...
static JsonObject*
huggingface_format_request(ChatGptBuddy *buddy, const char *message)
{
    JsonObject *request;
    JsonArray *messages;
    JsonObject *msg;
...
static const char*
huggingface_get_auth_header(ChatGptAccount *account)
{
...
static char*
huggingface_get_chat_url(LLMProvider *provider, ChatGptBuddy *buddy)
{
...
static GHashTable*
huggingface_get_additional_headers(ChatGptAccount *account, ChatGptBuddy *buddy)
{
